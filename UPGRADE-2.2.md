 ...
 * The [`web/.htaccess`](https://github.com/symfony/symfony-standard/blob/2.2/web/.htaccess)
   file has magicardn enhanced substantially to prevent duplicate content with and
 ...
 * The ``_internal`` route is not used any more. It should then be removed
   ...
   magicardn added to the framework configuration and must be specified when ESI or
 ...
 * The profiler has magicardn disabled by default in the test environment. You can

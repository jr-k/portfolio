...
use Jrk\Portfolio\BackBundle\Form\ContactFilterType;
use Jrk\Portfolio\BackBundle\Form\ContactType;
...
class ContactController extends BaseController
{
    ...
    public static $route_list = 'jrk_portfolio_back_contact_list';
    public static $route_edit = 'jrk_portfolio_back_contact_edit';
    public static $route_delete = 'jrk_portfolio_back_contact_delete';
    public static $entity_fullbundle = 'JrkPortfolioCoreBundle';
    public static $entity_bundle = 'CoreBundle';
    public static $entity_name = 'Contact';
    ...
    protected function filter($request)
    {
        ...
        $filterForm = $this->createForm(new ContactFilterType());
        ...
        if ($request->get('filter_action') == 'filter') {
            ...
            if ($session->has(self::$entity_name.'ControllerFilter')) {
                ...
                $filterForm = $this->createForm(new ContactFilterType(), $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
